...
def create_buttons(frame):
    ...
    """
    button0 = Button(frame, height=5, width=5, text=" ", command=lambda: on_click(button0))
    button0.pack(side=LEFT)
    button1 = Button(frame, height=5, width=5, text=" ", command=lambda: on_click(button1))
    button1.pack(side=LEFT)
    button2 = Button(frame, height=5, width=5, text=" ", command=lambda: on_click(button2))
...
#    global result, choices
    ...
    root.geometry("300x400")  # Improved the window geometry
    root.resizable(1, 1)
